...
module.exports = function (options) {
    ...
    function getPrioritizedLocaleIds(localeCookieValue, acceptLanguageHeaderValue) {
        ...
        if (req.accepts('html')) {
            ...
            if (matchDirAndFileName) {
                var dir = matchDirAndFileName[1],
                    ...
                    prioritizedLocaleIds = getPrioritizedLocaleIds(req.cookies && req.cookies[options.cookieName], req.headers['accept-language']);
