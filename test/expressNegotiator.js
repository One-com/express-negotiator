...
describe('express-negotiator', function () {
    ...
    createTest('/ Accept: */html, a non-mobile user agent and userAgent:true', {url: '/', headers: {accept: '*/html', 'user-agent': 'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; .NET4.0C)'}}, '/index.en_US.html', {userAgent: true});
    ...
    createTest('/bar Accept: */html, a non-mobile user agent and userAgent:true', {url: '/bar', headers: {accept: '*/html', 'user-agent': 'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; .NET4.0C)'}}, '/bar.nonmobile.html', {userAgent: true});
